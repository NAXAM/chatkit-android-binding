...
{
    public class CustomOutcomingImageMessageViewHolder : MessageHolders.OutcomingImageMessageViewHolder
    {
        public CustomOutcomingImageMessageViewHolder(View p0) : base(p0)
        {
